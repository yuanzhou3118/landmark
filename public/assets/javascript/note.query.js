    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var myhtml = '<table class="table table-striped table-hover table-condensed">'
                ...
                + '<th class="col-sm-4">Note_likes</th>'
                + '<th class="col-sm-2">Note_sort</th>'
            ...
            $.each(jsondata, function (i, item) {
                myhtml += '<tr class="row">'
                    ...
                    + '<td class="col-sm-1">' + item.content + '</td>'
                    + '<td class="col-sm-2">' + item.note_likes + '</td>'
                    + '<td class="col-sm-2">' + item.sort + '</td>'
                    + '<td class="col-sm-1">';
                myhtml += '<a href="' + window.eidtNote + item.id + '" class="btn btn-success" id="sort">编辑排序</a>';
                myhtml += '</td>'
