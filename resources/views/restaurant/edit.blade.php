                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form"
                              action="{{URL::route('admin.restaurant.edit.do',$restaurant->id)}}"
                              method="post">
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <select class="col-lg-2 col-sm-2 m-bot15" style="border: 0" name="description-lang"
                                        id="description-lang">
                                    <option value="en">EN</option>
                                    <option value="sc">SC</option>
                                    <option value="tc">TC</option>
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control description" id="en-description"
                                              name="en_description">
                                        {{$restaurant->en_description}}
                                    </textarea>
                                    <textarea class="form-control description" id="sc-description" name="sc_description"
                                              style="display: none">
                                        {{$restaurant->sc_description}}
                                    </textarea>
                                    <textarea class="form-control description" id="tc-description" name="tc_description"
                                              style="display: none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 booking_style">
                        ...
                        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form class="form-horizontal" role="form"
                                          action="{{URL::route('admin.restaurant.delete',$restaurant->id)}}"
                                          method="post">
                                        {{csrf_field()}}
                        ...
                        {{--<div class="form-group">--}}
                        {{--<form class="form-horizontal" role="form"--}}
                        {{--action="{{URL::route('admin.restaurant.delete',$restaurant->id)}}" method="post">--}}
                        {{--{{csrf_field()}}--}}
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            var image_url = '{{$restaurant->image_url}}';
            @if(mb_strlen($restaurant->image_url) > 0)
                var image_arr = image_url.split(';');
                var myimage = null;
            ...
            if (booking_style == 2) {
                $('.booking_style input:checkbox').eq(0).attr("checked", 'true');
                $('.booking_style input:checkbox').eq(1).attr("checked", 'true');
            } else {
